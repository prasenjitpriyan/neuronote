...
import { HoverCardSpotlight } from '@/components/motion/HoverCardSpotlight';
      ...
      <StaggerContainer className="relative z-10 max-w-lg text-center space-y-6">
        ...
        <StaggerItem>
          <p className="text-lg text-zinc-400 leading-relaxed">
            Write freely. AI automatically summarizes, tags, and indexes your
            notes — without ever slowing you down.
          </p>
        </StaggerItem>
          ...
          <StaggerItem key={f.title}>
            <div className="h-full">
              <HoverCardSpotlight>
                ...
                <h3 className="font-semibold text-white text-sm mt-4">
                  {f.title}
                </h3>
